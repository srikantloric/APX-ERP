  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      recieptData.forEach((data, index) => {
        ...
        doc.addImage(LOGO_BASE_64, x + 2, y + 3, 10, 8);
        doc.setFontSize(14);
        doc.setFont("Poppins", "bold");

        const schoolHeaderStartX = x + 15;
        const schoolHeaderStartY = y + 5;

        doc.text(
          SCHOOL_NAME.toUpperCase(),
          schoolHeaderStartX - 1,
        ...
        const schoolContactDetailStartY = schoolHeaderStartY + 6;
        ...
        doc.setFont("Poppins", "normal");
        doc.text(data.student_name, slipX + 16, slipY);
        doc.text(data.father_name, slipX + 16, slipY + 4);
        doc.text(
        ...
        doc.text(data.admission_no, slipX + 16, slipY + 8);
        doc.text(
        ...
        // Wrap due months
        const dueMonths = data.due_month.split(", ");
